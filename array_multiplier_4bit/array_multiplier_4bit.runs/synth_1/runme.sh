...
HD_PWD='C:/Users/tncya/Desktop/FPGA_COURSE/array_multiplier/array_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier_4bit_behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_multiplier_4bit_behavioral.tcl
