...
REM
REM Generated by Vivado on Thu May 07 04:50:32 +0300 2026
...
echo "xvlog --incr --relax -prj tb_array_multiplier_4bit_behavioral_vlog.prj"
call xvlog  --incr --relax -prj tb_array_multiplier_4bit_behavioral_vlog.prj -log xvlog.log
